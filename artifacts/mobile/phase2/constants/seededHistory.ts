...
const PERSONA_SEEDED_SESSIONS: Record<string, SeededSessionDef[]> = {
  ...
  'persona-marcus': [
    ...
    { scenarioId: 'goal-discovery', title: 'Setting up a payoff plan', daysAgoCreated: 18, daysAgoUpdated: 18 },
    { scenarioId: 'cross-product', title: 'Splitting my work bonus', daysAgoCreated: 28, daysAgoUpdated: 28 },
  ],
  'persona-jordan': [
    { scenarioId: 'goal-discovery', title: 'Building my debt payoff plan', daysAgoCreated: 5, daysAgoUpdated: 5 },
    { scenarioId: 'proactive-risk', title: 'Spending alert on my card', daysAgoCreated: 12, daysAgoUpdated: 12 },
    { scenarioId: 'cold-start', title: 'First chat with Coach', daysAgoCreated: 20, daysAgoUpdated: 20 },
  ],
  'persona-david': [
    ...
    { scenarioId: 'memory-lifecycle', title: 'Updating my financial preferences', daysAgoCreated: 20, daysAgoUpdated: 20 },
    { scenarioId: 'cross-product', title: 'Allocating my year-end bonus', daysAgoCreated: 32, daysAgoUpdated: 32 },
  ],
};
