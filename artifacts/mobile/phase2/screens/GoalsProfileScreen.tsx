...
function GoalCard({ goal }: { goal: Goal }) {
  ...
  return (
    <View style={[styles.goalCard, { backgroundColor: colors.surfaceElevated, shadowColor: colors.shadowColor }, isCompleted && { backgroundColor: colors.successBgLight }]}>
      ...
      {!isCompleted && (
        <Pressable style={[styles.askBtn, { borderColor: colors.surfaceEdge }]} onPress={() => navigate('chat')}>
          <Feather name="message-square" size={13} color={colors.contentBrand} />
          <Text style={[styles.askBtnText, { color: colors.contentBrand }]}>Ask about this goal</Text>
        </Pressable>
      )}
    </View>
  );
...
function SuggestedGoalCard({ goal }: { goal: Goal }) {
  ...
  return (
    <View style={[styles.suggestedCard, { backgroundColor: colors.surfaceElevated, borderColor: colors.surfaceEdge, shadowColor: colors.shadowColor }]}>
      <View style={styles.suggestedLabelRow}>
        <View style={[styles.suggestedBadge, { backgroundColor: colors.surfaceTint }]}>
          <Text style={[styles.suggestedBadgeText, { color: colors.contentSecondary }]}>Suggested</Text>
        </View>
      </View>
      <View style={styles.goalTop}>
        <View style={styles.goalInfo}>
