...
function SettingsMenuIcon({ size = 24, color = Colors.contentPrimary }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
          ...
          <View style={[styles.menuPositioner, { paddingTop: headerHeight }]}>
            <View style={styles.menuShadow}>
              <View style={styles.menuInner}>
                ...
                <Pressable style={styles.menuItem} onPress={() => { setActivePanel('settings'); setMenuOpen(false); }}>
                  <Text style={styles.menuText}>Settings</Text>
                  <SettingsMenuIcon size={24} color={Colors.contentPrimary} />
                </Pressable>
