...
function PauseMenuIcon({ size = 24, color = Colors.contentPrimary }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M9.75 5.75H8.41667C8.04848 5.75 7.75 6.04848 7.75 6.41667V17.75C7.75 18.1182 8.04848 18.4167 8.41667 18.4167H9.75C10.1182 18.4167 10.4167 18.1182 10.4167 17.75V6.41667C10.4167 6.04848 10.1182 5.75 9.75 5.75Z"
        stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"
      />
      <Path
        d="M15.5833 5.75H14.25C13.8818 5.75 13.5833 6.04848 13.5833 6.41667V17.75C13.5833 18.1182 13.8818 18.4167 14.25 18.4167H15.5833C15.9515 18.4167 16.25 18.1182 16.25 17.75V6.41667C16.25 6.04848 15.9515 5.75 15.5833 5.75Z"
        stroke={color} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"
      />
    </Svg>
  );
